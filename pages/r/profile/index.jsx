...
const UsersProfile = ({ id, token, refreshToken, role, Skill }) => {
            ...
            <div className="px-xl-3 py-xl-3 px-lg-3 py-lg-3 px-md-3 py-md-3 px-sm-3 py-sm-3 rounded">
              <div className="col-12 w-auto bg-white py-xl-3 px-lg-3 py-lg-3 px-md-0 py-md-3 px-sm-0 py-sm-3 rounded">
                <div className="tab-content" id="v-pills-tabContent" style={{ minHeight: `${size.height - 445}px` }}>
                  {/* const [tab0, setTab0] = useState(true); const [tab1, setTab1] = useState(false); const [tab2, setTab2] = useState(false); const [tab3, setTab3] = useState(false); const [tab4, setTab4] = useState(false); */}

                  {tab0 ? <RecruiterTabProfileRecruiterProfile statusEdit={statusEdit} setStatusEdit={setStatusEdit} token={token} refreshToken={refreshToken} role={role} id={id} isLoading={isLoading} /> : null}
                  {tab1 ? <RecruiterTabJobMyJob token={token} refreshToken={refreshToken} role={role} id={id} Skill={Skill} /> : null}
                  {tab2 ? <RecruiterTabJobCreateJob token={token} refreshToken={refreshToken} role={role} id={id} Skill={Skill} /> : null}
                  {/* {tab3 ? <RecruiterTabJobApplyStatusJob />: null} */}
                  {/* {tab4 ? : null} */}
                  {/* {tab5 ? : null} */}
                </div>
              </div>
