    ...
    <Fragment>
      <div className="register-page">
        <div className="container">
          ...
          <h5 className="text-banner text-center mb-3">
          ...
          <div className="mt-5">
            <form onSubmit={handleCreate}>
              <div className="my-3 mb-3">
                <div
                  className="mx-5 mb-5 d-flex justify-content-center align-items-center btn-group text-center justify-content-center"
                  role="group"
                >
                  <input
                    type="radio"
                ...
                />
                <input
                  className="form-control mt-3 hidden-textbox"
                  type="text"
                  placeholder="phone"
                  name="phone"
              ...
              <div className="d-flex justify-content-center">
                <p className="text-regis">
                  Already have a JobSeek account?&nbsp;
                </p>
