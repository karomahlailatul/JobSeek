...
const RecruiterTabJobMyJob = ({ token, refreshToken, role, id, Skill }) => {
  ...
  return (
    ...
    //       <div style={{ display: !showMyJob ? "block" : "none" }}>
    //         <RecruiterTabJobEditJob token={token} refreshToken={refreshToken} role={role} id={id} Skill={Skill} idJob={idJob} setIdJob={setIdJob} showMyJob = {showMyJob} setShowMyJob={setShowMyJob} />
    //       </div>
    //     </div>
    //   )}
    // </div> 
