...
const UsersTabPortfolioCreatePortfolio = () => {
  ...
  return (
    ...
    // </Fragment>
    <Fragment>
      <div className="tab-pane fade" id="v-pills-create-portfolio" role="tabpanel" aria-labelledby="v-pills-create-portfolio-tab" data-toggle="button">
        <div className="my-5">
          <div className="container-fluid">
...
export default UsersTabPortfolioCreatePortfolio