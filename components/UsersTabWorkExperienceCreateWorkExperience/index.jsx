...
const UsersTabWorkExperienceCreateWorkExperience = () => {
  return (
    // <Fragment>
    ...
    // </Fragment>
    <Fragment>
      <div className="tab-pane fade show" id="v-pills-create-work-experience" role="tabpanel" aria-labelledby="v-pills-create-work-experience-tab" data-toggle="button">
        <div className="my-5">
          <div className="container-fluid">
...
export default UsersTabWorkExperienceCreateWorkExperience;
