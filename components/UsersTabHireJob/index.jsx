...
const UsersTabHireJob = () => {
  ...
  return (
    ...
    <Fragment>
      <div className="tab-pane fade show" id="v-pills-hire-job" role="tabpanel" aria-labelledby="v-pills-hire-job-tab" data-toggle="button">
        <div className="my-5">
          <div className="container-fluid">
            <p>hire-job</p>
          </div>
...
export default UsersTabHireJob;
